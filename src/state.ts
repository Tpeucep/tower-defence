...
export const mapConfigs: MapConfig[] = [
  {
    ...
    towers: [
      ...
      { x: 315, y: 370, type: TowerType.Base },
    ],
    ...
    vawes: [
      ...
      { time: 21, mob: MobType.Orc, road: 0},
      { time: 23, mob: MobType.Goblin, road: 0 },
      ////
      ...
      { time: 55, mob: MobType.Orc, road: 1  },
      { time: 57, mob: MobType.Orc, road: 1  },
    ],
  },
  {
    id: 1,
    ...
    vawes: [
      ...
      ////
      { time: 38, mob: MobType.Goblin, road: 0  },
      { time: 39, mob: MobType.Goblin, road: 0  },
      { time: 40, mob: MobType.Goblin, road: 0  },
      { time: 41, mob: MobType.Goblin, road: 0  },
      { time: 42, mob: MobType.Goblin, road: 0  },
      { time: 43, mob: MobType.Goblin, road: 0  },
      { time: 44, mob: MobType.Goblin, road: 0  },
      { time: 45, mob: MobType.Goblin, road: 0  },
      { time: 46, mob: MobType.Goblin, road: 0  },
    ],
  },
  {
    id: 2,
    ...
    vawes: [
      ...
      { time: 9, mob: MobType.Goblin, road: 0 },
      { time: 11, mob: MobType.Goblin, road: 0 },
